...
public class TrackingClassWeaverTest extends WeaverTestBase {
	...
	public void setUp() throws Exception {
		...
		clazz = new Clazz(id, name, parent, parentName, 0);
		record = new ClassRecord(clazz);
		record.addFields(Lists.<Field>newArrayList(
				new Field(new FieldId((short) 0, 1, (short) 1), "engaged", id, name,
						"I", ACC_PRIVATE | ACC_STATIC),
				new Field(new FieldId((short) 0, 1, (short) 2), "cnum", id, name,
						"I", ACC_PRIVATE | ACC_STATIC),
				new Field(new FieldId((short) 0, 1, (short) 3), "nullCounter", id, name,
						"Lnz/ac/vuw/ecs/rprof/HeapTracker;", ACC_PRIVATE | ACC_STATIC),
				new Field(new FieldId((short) 0, 1, (short) 4), "nextThreadId", id, name,
						"S", ACC_PRIVATE | ACC_STATIC | ACC_VOLATILE),
				new Field(new FieldId((short) 0, 1, (short) 5), "thread", id, name,
						"J", ACC_PRIVATE | ACC_FINAL),
				new Field(new FieldId((short) 0, 1, (short) 6), "counter", id, name,
						"J", ACC_PRIVATE)
		));
		record.addMethods(Lists.<Method>newArrayList(
				new Method(new MethodId((short) 0, 1, (short) 1), "create", id, name,
						"()Lnz/ac/vuw/ecs/rprof/HeapTracker;", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 2), "_newcls", id, name,
						"(Ljava/lang/Object;I[I)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 3), "newcls", id, name,
						"(Ljava/lang/Object;I[I)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 4), "_newobj", id, name,
						"(Ljava/lang/Object;Ljava/lang/Object;J)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 5), "newobj", id, name,
						"(Ljava/lang/Object;)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 6), "_newarr", id, name,
						"(Ljava/lang/Object;Ljava/lang/Object;J)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 7), "newarr", id, name,
						"(Ljava/lang/Object;)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 8), "_menter", id, name,
						"(Ljava/lang/Object;II[Ljava/lang/Object;)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 9), "enter", id, name,
						"(II[Ljava/lang/Object;)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 10), "_mexit", id, name,
						"(Ljava/lang/Object;IILjava/lang/Object;)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 11), "exit", id, name,
						"(IILjava/lang/Object;)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 12), "_mexcept", id, name,
						"(Ljava/lang/Object;IILjava/lang/Object;)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 13), "except", id, name,
						"(IILjava/lang/Object;)V", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 14), "_main", id, name,
						"(Ljava/lang/Object;II)V", ACC_PRIVATE | ACC_STATIC | ACC_NATIVE),
				new Method(new MethodId((short) 0, 1, (short) 15), "main", id, name,
						"(II)V", ACC_PUBLIC | ACC_STATIC),

				new Method(new MethodId((short) 0, 1, (short) 16), "id", id, name,
						"(Ljava/lang/Object;)J", ACC_PRIVATE | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 17), "getTracker", id, name,
						"()Lnz/ac/vuw/ecs/rprof/HeapTracker;", ACC_PRIVATE | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 18), "_getTracker", id, name,
						"(Ljava/lang/Thread;)Lnz/ac/vuw/ecs/rprof/HeapTracker;", ACC_PUBLIC | ACC_STATIC),
				new Method(new MethodId((short) 0, 1, (short) 19), "_setTracker", id, name,
						"(Ljava/lang/Thread;Lnz/ac/vuw/ecs/rprof/HeapTracker;)V", ACC_PUBLIC | ACC_STATIC),

				new Method(new MethodId((short) 0, 1, (short) 20), "nextThreadId", id, name,
						"()S", ACC_PRIVATE | ACC_STATIC | ACC_SYNCHRONIZED),

				new Method(new MethodId((short) 0, 1, (short) 21), "<init>", id, name,
						"()V", ACC_PRIVATE),
				new Method(new MethodId((short) 0, 1, (short) 22), "<init>", id, name,
						"(S)V", ACC_PRIVATE),
				new Method(new MethodId((short) 0, 1, (short) 23), "newId", id, name,
						"()J", ACC_PUBLIC),
				new Method(new MethodId((short) 0, 1, (short) 24), "<clinit>", id, name,
						"()V", ACC_STATIC)
		));
	}
