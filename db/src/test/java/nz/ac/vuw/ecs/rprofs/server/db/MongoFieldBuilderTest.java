...
public class MongoFieldBuilderTest {
	...
	public void testGet() throws Exception {
		...
		Assert.assertEquals(fieldId, f.getId());
		Assert.assertEquals(name, f.getName());
		Assert.assertEquals(desc, f.getDescription());
		Assert.assertEquals(access, f.getAccess());
		Assert.assertEquals(clazzId, f.getOwner());
		Assert.assertEquals(cname, f.getOwnerName());
	}
}
